...
// Flags going INTO Rust are LongBool, not boolean: a one-byte Pascal boolean
// leaves the upper bits of the argument register dirty, and Rust reads the
// whole register. See the note on hwf_raw in rust/.../fpnum.rs.
